    ...
    <div> <!-- for some reason if you do not put an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                ...
                <div class="main_container">
                    <div class="row">
                        <div class="col-md-6" v-if="address" style="margin-bottom: 20px">
	...
	define(["Vue", "vuex", "vue!google_map", "json!site.json"], function(Vue, Vuex, google_map, Site ) {
		return Vue.component("location-component", {
                ...
                this.loadData().then(response => {
                    ...
                    if (response && response[1]){
                        ...
                        if(response[1].data && response[1].data.subpages){
                           ...
                           this.descriptions = response[1].data.subpages[2];
                        }
                    }
            ...
            methods: {
                ...
                propertyAddress() {
                    var address = this.property.name + " +" + this.property.address1 + "+" + this.property.city + "+" + this.property.province_state + "+"  + this.property.postal_code + "+" + this.property.country
