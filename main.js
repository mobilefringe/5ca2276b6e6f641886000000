    ...
    const vm = new Vue({
        ...
        data: function () {
            return {
                ...
                social_media: [
                    {
                        name: "Facebook",
                        url: "https://www.facebook.com/riverside.plaza",
                    ...
                    {
                        name: "Instagram",
                        url: "https://www.instagram.com/ShopRiversidePlaza",
        ...
        methods: {
            loadData: async function() {
                try{
                    await this.$store.dispatch('initializeApi', { site: "riverside", version: "v4" });
