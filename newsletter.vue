    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-if="pageBanner" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)),  #434037 url(' + pageBanner.image_url + ') center center rgba(67, 64, 55)' }">
                ...
                <div class="main_container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="newsletter_form form-horizontal" action="//mobilefringe.createsend.com/t/d/s/uljild/" method="post">
                                <div class="row">
                                    <div class="col-sm-6" >
                                    ...
                                    <div class="col-sm-6" >
                                        ...
                                        <input v-model="form_data.last_name" required class="margin_20 form-control" id="fieldgjksd" name="cm-f-gjksd" type="text" placeholder="Last Name">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label for="newsletter_email" class="accessibility">Email</label>
                                        <input v-model="form_data.email" required class="margin_20 form-control" name="cm-uljild-uljild" type="email" placeholder="Email" id="newsletter_email">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
            ...
            created() {
                this.loadData().then(response => {
                    ...
                    if (temp_repo != null && temp_repo != undefined) {
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5d6edb476e6f646236120000/image/png/1554994625000/riverside_paceholder_banner.png"
                        }
                    }
