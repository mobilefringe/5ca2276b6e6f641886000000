    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), #434037 url(' + pageBanner.image_url + ') center center' }">
                ...
                updateCurrentStore(id) {
                    ...
                    if (this.currentStore === null || this.currentStore === undefined) {
                        ...
                        if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                            ...
                            if (_.includes(subcategories, 8895)) {
                                this.hasUberEats = true;
                            }
                            if (_.includes(subcategories, 8891)) {
                                this.hasDoordash = true;
                            }
                            if (_.includes(subcategories, 8893)) {
                                this.hasGrubhub = true;
                            }
                            if (_.includes(subcategories, 8892)) {
                                this.hasPostmates = true;   
                            }
                            if (_.includes(subcategories, 8894)) {
                        ...
                        _.forEach(this.currentStore.promotions, function(value, key) {
                            ...
                            if (_.includes(current_promo.image_url, 'missing')) {
                                current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5de031406e6f6416dbb80000/image/png/1554994818000/riverside_default_image.png";
                            }
                        ...
                        _.forEach(this.currentStore.events, function(value, key) {
                            ...
                            if (_.includes(current_event.image_url, 'missing')) {
                                current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5de031406e6f6416dbb80000/image/png/1554994818000/riverside_default_image.png";
                            }
